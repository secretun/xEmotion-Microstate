...
file_path = 'E:/SEED/官网数据/Preprocessed_EEG/'
...
np.save("E:/ER-4D-CRNN-main/result/X.npy", X)
np.save("E:/ER-4D-CRNN-main/result/y.npy", y)




X = np.load('E:/ER-4D-CRNN-main/result/X.npy')
y = np.load('E:/ER-4D-CRNN-main/result/y.npy')
...
np.save("E:/ER-4D-CRNN-main/result/X89.npy", X89)
