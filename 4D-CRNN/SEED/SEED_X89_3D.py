# 数据组织
import numpy as np
X89 = np.load("E:/ER-4D-CRNN-main/result/X89.npy")
...
np.save('E:/ER-4D-CRNN-main/result/t'+str(t)+'x_89.npy', new_x)
np.save('E:/ER-4D-CRNN-main/result/t'+str(t)+'y_89.npy', new_y)
