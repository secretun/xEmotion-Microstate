...
%  Implementation of the Modified K-means algorithm, with optional 改进的K-means算法的实现，如[1]所述的分段可选平滑。
...
%  K_range - A priori number of microstates. Can be a vector.先验的微观状态数,可以是一个矢量
%
%  Optional inputs
%  opts.
...
%% Readying measure of fit for selecting best segmentation 选择最佳分割的拟合准备措施  
switch fitmeas
    case 'GEV'
        GFP = std(X);
        GFP_const = sum(GFP.^2);
