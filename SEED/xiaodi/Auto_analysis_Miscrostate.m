...
EEGdir = 'E:\SEED\SEED_EEG\分频段数据\1_20131027\1\';
...
disp(length(ALLEEG));      % 输出 ALLEEG 数组的长度
disp(CURRENTSET);          % 输出 CURRENTSET 的值
...
eeglab redraw % updates EEGLAB datasetsALLERPCOM
...
'plotsegnos', 'first', 'plot_time', [100 10000], 'plottopos', 1 );
eeglab redraw